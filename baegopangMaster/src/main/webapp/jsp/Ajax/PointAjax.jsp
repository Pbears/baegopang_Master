...
<body>
 ...
 --%>
	<div id="rankdiv">
		...
		<div id="rank">
		    <%-- <h4 style="color: #FF8C00; margin-left: 10px; font-weight: bold;">${cnt.count }등</h4> --%>
		...
		<div id="rank_con">
			...
			<h4 style="font-weight: bold; font-style: italic; color: red; font-size: 15px;">${i.point }팡</h4>
			</div>
		</div>
		</div>
	<%-- 	<%
		...
		<c:otherwise>
		<div id="srank"><h4>${cnt.count }등</h4>
		<div id="rank_subcon">
			<img src="img/noimg.jpg">
			<h3 id="rank_subcon_title_4">${i.storename }</h3>
			<h3 id="rank_subcon_point_4">${i.point }팡</h3>
		</div>
		</div>	
<%-- 		<%		}
			}
		...
		<div id="myrank">
			<div id="myBrank">
				...
				<h4 style="font-weight: bold; font-style: italic; color:#FF8C00;  font-size: 20px;">${bbean.num }등</h4>
				<h4 style="font-weight: bold; margin-top: 10px;">${bbean.storename }</h4>
				<h4 style="font-weight: bold; font-style: italic; color: red; font-size: 15px;">${bbean.point }팡</h4>
			</div>
			<div id="myGrank">
				<h4>구 별 순위</h4>
				<img src="img/noimg.jpg" width="100px" height="100px" style="border-radius: 50px; ">
				<h4 style="font-weight: bold; font-style: italic; color:#FF8C00;  font-size: 20px;">${gbean.num }등</h4>
				<h4 style="font-weight: bold; margin-top: 10px;">${gbean.storename }</h4>
				<h4 style="font-weight: bold; font-style: italic; color: red; font-size: 15px;">${gbean.point }팡</h4>
			</div>
		</div>
		<%-- <%		
			}
